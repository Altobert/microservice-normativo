    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .contact(new Contact()
                                .name("Proyecto de Titulo Sistema de Búsqueda de Documentos Normativos")
                                .email("albertosanmartin@usach.cl")
                                .url("https://www.sii.cl"))
                        .license(new License()
                                .name("Licencia Pública de la Universidad de Santiago de Chile")
